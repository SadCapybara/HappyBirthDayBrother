...
const wishes = [
  {
    label: "Капибарье поздравление! 🐉 (это капибара)",
    wish: "В этот день тебе не надо делать того, что может сжечь твои калории. Лежи и наслаждайся жизнью. Балдёжного тебе настроения.",
    weight: 0.3
  },
  {
    label: "Лягушачье  ̶с̶р̶е̶д̶а̶ поздравление 🐸",
    wish: "Это твой день, мой чувак! Пусть каждый день будет для тебя так же хорош и прекрасен как любая среда!",
    weight: 0.2
  },
  {
    label: "Медвежья поздравительная услуга🐻",
    wish: "Пусть в жизни будет побольше мёда и больше мягких объятий!",
    weight: 0.2
  },
  {
    label: "Ёжик абсурда 🦔",
    wish: "Желаю что бы твой путь каждый день освещала светлая луна, а муравьи уступали дорогу! ",
    weight: 0.15
  },
  {
    label: "Кошачий мем 🐱",
    wish: "Желаю тебе видеть больше картинок и мемов с котиками!",
    weight: 0.1
  },
  {
    label: "Енот украл это поздравление 🦝",
    wish: "Желаю тебе найти украденное енотом поздравление!",
    weight: 0.05
  }
];
